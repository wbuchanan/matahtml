...
void optgroup::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class optgroup
...
void optgroup::set(| string scalar disabled) { 
...
void optgroup::set(| string scalar text) { 
...
void optgroup::set(| string scalar script) { 
...
string scalar optgroup::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class optgroup
