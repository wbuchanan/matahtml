...
void summary::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class summary
...
void summary::set(| string scalar script) { 
...
string scalar summary::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class summary
