...
void footer::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class footer
...
void footer::set(| string scalar script) { 
...
string scalar footer::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class footer
