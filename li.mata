...
void li::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class li
...
void li::set(| string scalar 1, string scalar A, string scalar a, string scalar I, string scalar i, string scalar disc, string scalar square, string scalar circle) { 

    // Declare member variables based on arguments 
    string scalar loc1, "locA", "loca", "locI", "loci", "locdisc", "locsquare", "loccircle" 
    ...
    // Set the attribute  for this class 
    this. = loc1 + "locA" + "loca" + "locI" + "loci" + "locdisc" + "locsquare" + "loccircle"
...
void li::set(| string scalar script) { 
...
void li::set(| string scalar number) { 
...
string scalar li::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class li
