...
void ul::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class ul

// Not supported in HTML5. Specifies that the list should render smaller than normal 
void ul::set(| string scalar compact) { 

    // Declare member variables based on arguments 
    string scalar loccompact 
...
void ul::set(| string scalar disc, string scalar square, string scalar circle) { 

    // Declare member variables based on arguments 
    string scalar locdisc, "locsquare", "loccircle" 
    ...
    // Set the attribute  for this class 
    this. = locdisc + "locsquare" + "loccircle"
...
void ul::set(| string scalar script) { 
...
string scalar ul::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class ul
