...
class track { 
    ...
    // Setter methods 
    class        track     scalar  setClassArgs(), setAccesskey(), setClass(), setContenteditable(), setContextmenu(), setData(), setDefault(), setDir(), setDraggable(), setDropzone(), setHidden(), setId(), setKind(), setLabel(), setLang(), setOnabort(), setOnafterprint(), setOnbeforeprint(), setOnbeforeunload(), setOnblur(), setOncanplay(), setOncanplaythrough(), setOnchange(), setOnclick(), setOncontextmenu(), setOncopy(), setOncuechange(), setOncut(), setOndblclick(), setOndrag(), setOndragend(), setOndragenter(), setOndragleave(), setOndragover(), setOndragstart(), setOndrop(), setOndurationchange(), setOnemptied(), setOnended(), setOnerror(), setOnfocus(), setOnhashchange(), setOninput(), setOninvalid(), setOnkeydown(), setOnkeypress(), setOnkeyup(), setOnload(), setOnloadeddata(), setOnloadedmetadata(), setOnloadstart(), setOnmessage(), setOnmousedown(), setOnmousemove(), setOnmouseout(), setOnmouseover(), setOnmouseup(), setOnmousewheel(), setOnoffline(), setOnonline(), setOnpagehide(), setOnpageshow(), setOnpaste(), setOnpause(), setOnplay(), setOnplaying(), setOnpopstate(), setOnprogress(), setOnratechange(), setOnreset(), setOnresize(), setOnscroll(), setOnsearch(), setOnseeked(), setOnseeking(), setOnselect(), setOnshow(), setOnstalled(), setOnstorage(), setOnsubmit(), setOnsuspend(), setOntimeupdate(), setOntoggle(), setOnunload(), setOnvolumechange(), setOnwaiting(), setOnwheel(), setSpellcheck(), setSrc(), setSrclang(), setStyle(), setTabindex(), setTitle(), setTranslate()

    // Getter methods 
    string               scalar          getOpens(), getOpene(), getClose(), print(), getClassArgs(), getAccesskey(), getClass(), getContenteditable(), getContextmenu(), getData(), getDefault(), getDir(), getDraggable(), getDropzone(), getHidden(), getId(), getKind(), getLabel(), getLang(), getOnabort(), getOnafterprint(), getOnbeforeprint(), getOnbeforeunload(), getOnblur(), getOncanplay(), getOncanplaythrough(), getOnchange(), getOnclick(), getOncontextmenu(), getOncopy(), getOncuechange(), getOncut(), getOndblclick(), getOndrag(), getOndragend(), getOndragenter(), getOndragleave(), getOndragover(), getOndragstart(), getOndrop(), getOndurationchange(), getOnemptied(), getOnended(), getOnerror(), getOnfocus(), getOnhashchange(), getOninput(), getOninvalid(), getOnkeydown(), getOnkeypress(), getOnkeyup(), getOnload(), getOnloadeddata(), getOnloadedmetadata(), getOnloadstart(), getOnmessage(), getOnmousedown(), getOnmousemove(), getOnmouseout(), getOnmouseover(), getOnmouseup(), getOnmousewheel(), getOnoffline(), getOnonline(), getOnpagehide(), getOnpageshow(), getOnpaste(), getOnpause(), getOnplay(), getOnplaying(), getOnpopstate(), getOnprogress(), getOnratechange(), getOnreset(), getOnresize(), getOnscroll(), getOnsearch(), getOnseeked(), getOnseeking(), getOnselect(), getOnshow(), getOnstalled(), getOnstorage(), getOnsubmit(), getOnsuspend(), getOntimeupdate(), getOntoggle(), getOnunload(), getOnvolumechange(), getOnwaiting(), getOnwheel(), getSpellcheck(), getSrc(), getSrclang(), getStyle(), getTabindex(), getTitle(), getTranslate()
...
class track scalar track::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class track

// Specifies one or more classnames for an element (refers to a class in a style sheet) 
class track scalar track::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class track

// Specifies whether the content of an element is editable or not 
class track scalar track::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class track

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class track scalar track::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class track

// Used to store custom data private to the page or application 
class track scalar track::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class track
...
class track scalar track::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class track

// Specifies whether an element is draggable or not 
class track scalar track::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class track

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class track scalar track::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class track

// Specifies that an element is not yet, or is no longer, relevant 
class track scalar track::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class track

// Specifies a unique id for an element 
class track scalar track::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class track
...
class track scalar track::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class track

// Script to be run on abort 
class track scalar track::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class track

// Script to be run after the document is printed 
class track scalar track::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class track

// Script to be run before the document is printed 
class track scalar track::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class track

// Script to be run when the document is about to be unloaded 
class track scalar track::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class track

// Fires the moment that the element loses focus 
class track scalar track::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class track

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class track scalar track::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class track

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class track scalar track::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class track

// Fires the moment when the value of the element is changed 
class track scalar track::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class track

// Fires on a mouse click on the element 
class track scalar track::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class track

// Script to be run when a context menu is triggered 
class track scalar track::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class track

// Fires when the user copies the content of an element 
class track scalar track::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class track

// Script to be run when the cue changes in a <track> element 
class track scalar track::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class track

// Fires when the user cuts the content of an element 
class track scalar track::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class track

// Fires on a mouse double-click on the element 
class track scalar track::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class track

// Script to be run when an element is dragged 
class track scalar track::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class track

// Script to be run at the end of a drag operation 
class track scalar track::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class track

// Script to be run when an element has been dragged to a valid drop target 
class track scalar track::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class track

// Script to be run when an element leaves a valid drop target 
class track scalar track::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class track

// Script to be run when an element is being dragged over a valid drop target 
class track scalar track::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class track

// Script to be run at the start of a drag operation 
class track scalar track::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class track

// Script to be run when dragged element is being dropped 
class track scalar track::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class track

// Script to be run when the length of the media changes 
class track scalar track::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class track

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class track scalar track::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class track

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class track scalar track::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class track

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class track scalar track::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class track

// Fires the moment when the element gets focus 
class track scalar track::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class track

// Script to be run when there has been changes to the anchor part of the a URL 
class track scalar track::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class track

// Script to be run when an element gets user input 
class track scalar track::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class track

// Script to be run when an element is invalid 
class track scalar track::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class track

// Fires when a user is pressing a key 
class track scalar track::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class track

// Fires when a user presses a key 
class track scalar track::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class track

// Fires when a user releases a key 
class track scalar track::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class track

// Fires after the page is finished loading 
class track scalar track::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class track

// Script to be run when media data is loaded 
class track scalar track::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class track

// Script to be run when meta data (like dimensions and duration) are loaded 
class track scalar track::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class track

// Script to be run just as the file begins to load before anything is actually loaded 
class track scalar track::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class track

// Script to be run when the message is triggered 
class track scalar track::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class track

// Fires when a mouse button is pressed down on an element 
class track scalar track::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class track

// Fires when the mouse pointer is moving while it is over an element 
class track scalar track::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class track

// Fires when the mouse pointer moves out of an element 
class track scalar track::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class track

// Fires when the mouse pointer moves over an element 
class track scalar track::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class track

// Fires when a mouse button is released over an element 
class track scalar track::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class track

// Deprecated. Use the onwheel attribute instead 
class track scalar track::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class track

// Script to be run when the browser starts to work offline 
class track scalar track::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class track

// Script to be run when the browser starts to work online 
class track scalar track::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class track

// Script to be run when a user navigates away from a page 
class track scalar track::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class track

// Script to be run when a user navigates to a page 
class track scalar track::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class track

// Fires when the user pastes some content in an element 
class track scalar track::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class track

// Script to be run when the media is paused either by the user or programmatically 
class track scalar track::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class track

// Script to be run when the media is ready to start playing 
class track scalar track::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class track

// Script to be run when the media actually has started playing 
class track scalar track::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class track

// Script to be run when the window's history changes 
class track scalar track::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class track

// Script to be run when the browser is in the process of getting the media data 
class track scalar track::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class track

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class track scalar track::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class track

// Fires when the Reset button in a form is clicked 
class track scalar track::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class track

// Fires when the browser window is resized 
class track scalar track::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class track

// Script to be run when an element's scrollbar is being scrolled 
class track scalar track::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class track

// Fires when the user writes something in a search field (for <input="search">) 
class track scalar track::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class track

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class track scalar track::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class track

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class track scalar track::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class track

// Fires after some text has been selected in an element 
class track scalar track::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class track

// Fires when a <menu> element is shown as a context menu 
class track scalar track::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class track

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class track scalar track::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class track

// Script to be run when a Web Storage area is updated 
class track scalar track::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class track

// Fires when a form is submitted 
class track scalar track::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class track

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class track scalar track::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class track

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class track scalar track::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class track

// Fires when the user opens or closes the <details> element 
class track scalar track::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class track

// Fires once a page has unloaded (or the browser window has been closed) 
class track scalar track::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class track

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class track scalar track::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class track

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class track scalar track::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class track

// Fires when the mouse wheel rolls up or down over an element 
class track scalar track::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class track

// Specifies whether the element is to have its spelling and grammar checked or not 
class track scalar track::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class track
...
class track scalar track::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class track

// Specifies the tabbing order of an element 
class track scalar track::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class track

// Specifies extra information about an element 
class track scalar track::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class track

// Specifies whether the content of an element should be translated or not 
class track scalar track::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class track
...
string scalar track::print() { 
    ...
    open = getOpens() + getAccesskey() + getClass() + getContenteditable() + getContextmenu() + getData() + getDefault() + getDir() + getDraggable() + getDropzone() + getHidden() + getId() + getKind() + getLabel() + getLang() + getOnabort() + getOnafter + getOnbefore + getOnbeforeunload() + getOnblur() + getOncanplay() + getOncanplaythrough() + getOnchange() + getOnclick() + getOncontextmenu() + getOncopy() + getOncuechange() + getOncut() + getOndblclick() + getOndrag() + getOndragend() + getOndragenter() + getOndragleave() + getOndragover() + getOndragstart() + getOndrop() + getOndurationchange() + getOnemptied() + getOnended() + getOnerror() + getOnfocus() + getOnhashchange() + getOninput() + getOninvalid() + getOnkeydown() + getOnkeypress() + getOnkeyup() + getOnload() + getOnloadeddata() + getOnloadedmetadata() + getOnloadstart() + getOnmessage() + getOnmousedown() + getOnmousemove() + getOnmouseout() + getOnmouseover() + getOnmouseup() + getOnmousewheel() + getOnoffline() + getOnonline() + getOnpagehide() + getOnpageshow() + getOnpaste() + getOnpause() + getOnplay() + getOnplaying() + getOnpopstate() + getOnprogress() + getOnratechange() + getOnreset() + getOnresize() + getOnscroll() + getOnsearch() + getOnseeked() + getOnseeking() + getOnselect() + getOnshow() + getOnstalled() + getOnstorage() + getOnsubmit() + getOnsuspend() + getOntimeupdate() + getOntoggle() + getOnunload() + getOnvolumechange() + getOnwaiting() + getOnwheel() + getSpellcheck() + getSrc() + getSrclang() + getStyle() + getTabindex() + getTitle() + getTranslate() + getOpene()
