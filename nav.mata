...
void nav::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class nav
...
void nav::set(| string scalar script) { 
...
string scalar nav::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class nav
