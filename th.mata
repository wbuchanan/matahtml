...
class th { 
    ...
    string                                                       scalar                  abbr, accesskey, align, axis, bgcolor, char, charoff, colspan, contenteditable, contextmenu, data, draggable, dropzone, headers, height, hidden, htmlclass, htmldir, htmltranslate, id, lang, nowrap, onabort, onafterprint, onbeforeprint, onbeforeunload, onblur, oncanplay, oncanplaythrough, onchange, onclick, oncontextmenu, oncopy, oncuechange, oncut, ondblclick, ondrag, ondragend, ondragenter, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onerror, onfocus, onhashchange, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadstart, onmessage, onmousedown, onmousemove, onmouseout, onmouseover, onmouseup, onmousewheel, onoffline, ononline, onpagehide, onpageshow, onpaste, onpause, onplay, onplaying, onpopstate, onprogress, onratechange, onreset, onresize, onscroll, onsearch, onseeked, onseeking, onselect, onshow, onstalled, onstorage, onsubmit, onsuspend, ontimeupdate, ontoggle, onunload, onvolumechange, onwaiting, onwheel, rowspan, scope, sorted, spellcheck, style, tabindex, title, valign, width

    // Define public members/methods 
    public: 

    // Setter methods 
    void                 new(), setClassArgs(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set(), set()

    // Getter methods 
    string                       scalar                  getOpens(), getOpene(), getClose(), print(), getClassargs(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()
...
void th::set(| string scalar text) { 
...
} // End of Method  declaration for class th

// Specifies a shortcut key to activate/focus an element 
void th::set(| string scalar methodarg) { 
...
void th::set(| string scalar left, string scalar right, string scalar center, string scalar justify, string scalar char) { 
...
void th::set(| string scalar category_name) { 
...
void th::set(| string scalar rgb(x,x,x), string scalar #xxxxxx, string scalar colorname) { 
...
void th::set(| string scalar character) { 
...
void th::set(| string scalar number ) { 
...
void th::set(| string scalar header_id) { 
...
void th::set(| string scalar pixels, string scalar %) { 
...
void th::set(| string scalar nowrap) { 
...
void th::set(| string scalar script) { 
...
void th::set(| string scalar col, string scalar colgroup, string scalar row, string scalar rowgroup) { 
...
void th::set(| string scalar reversednumberreversed, string scalar numbernumber, string scalar reversed) { 

    // Declare member variables based on arguments 
    string scalar locreversednumberreversed, "locnumbernumber", "locreversed" 

    // Initialize the local variable 1
    locreversednumberreversed = `" = ""' + reversednumberreversed + `"""' 

    // Initialize the local variable 2
    locnumbernumber = `" = ""' + numbernumber + `"""' 

    // Initialize the local variable 3
    locreversed = `" = ""' + reversed + `"""' 

    // Set the attribute  for this class 
    this. = locreversednumberreversed + "locnumbernumber" + "locreversed"
...
void th::set(| string scalar top, string scalar middle, string scalar bottom, string scalar baseline) { 
...
string scalar th::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class th
...
string scalar th::print() { 
    ...
    open = getOpens() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + get() + getOpene()
