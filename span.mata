...
void span::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class span
...
void span::set(| string scalar script) { 
...
string scalar span::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class span
