...
class embed scalar embed::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class embed

// Specifies one or more classnames for an element (refers to a class in a style sheet) 
class embed scalar embed::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class embed

// Specifies whether the content of an element is editable or not 
class embed scalar embed::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class embed

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class embed scalar embed::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class embed

// Used to store custom data private to the page or application 
class embed scalar embed::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class embed

// Specifies the text direction for the content in an element 
class embed scalar embed::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class embed

// Specifies whether an element is draggable or not 
class embed scalar embed::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class embed

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class embed scalar embed::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class embed
...
class embed scalar embed::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class embed

// Specifies a unique id for an element 
class embed scalar embed::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class embed

// Specifies the language of the element's content 
class embed scalar embed::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class embed

// Script to be run on abort 
class embed scalar embed::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class embed

// Script to be run after the document is printed 
class embed scalar embed::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class embed

// Script to be run before the document is printed 
class embed scalar embed::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class embed

// Script to be run when the document is about to be unloaded 
class embed scalar embed::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class embed

// Fires the moment that the element loses focus 
class embed scalar embed::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class embed

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class embed scalar embed::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class embed

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class embed scalar embed::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class embed

// Fires the moment when the value of the element is changed 
class embed scalar embed::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class embed

// Fires on a mouse click on the element 
class embed scalar embed::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class embed

// Script to be run when a context menu is triggered 
class embed scalar embed::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class embed

// Fires when the user copies the content of an element 
class embed scalar embed::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class embed

// Script to be run when the cue changes in a <track> element 
class embed scalar embed::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class embed

// Fires when the user cuts the content of an element 
class embed scalar embed::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class embed

// Fires on a mouse double-click on the element 
class embed scalar embed::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class embed

// Script to be run when an element is dragged 
class embed scalar embed::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class embed

// Script to be run at the end of a drag operation 
class embed scalar embed::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class embed

// Script to be run when an element has been dragged to a valid drop target 
class embed scalar embed::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class embed

// Script to be run when an element leaves a valid drop target 
class embed scalar embed::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class embed

// Script to be run when an element is being dragged over a valid drop target 
class embed scalar embed::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class embed

// Script to be run at the start of a drag operation 
class embed scalar embed::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class embed

// Script to be run when dragged element is being dropped 
class embed scalar embed::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class embed

// Script to be run when the length of the media changes 
class embed scalar embed::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class embed

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class embed scalar embed::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class embed

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class embed scalar embed::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class embed

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class embed scalar embed::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class embed

// Fires the moment when the element gets focus 
class embed scalar embed::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class embed

// Script to be run when there has been changes to the anchor part of the a URL 
class embed scalar embed::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class embed

// Script to be run when an element gets user input 
class embed scalar embed::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class embed

// Script to be run when an element is invalid 
class embed scalar embed::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class embed

// Fires when a user is pressing a key 
class embed scalar embed::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class embed

// Fires when a user presses a key 
class embed scalar embed::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class embed

// Fires when a user releases a key 
class embed scalar embed::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class embed

// Fires after the page is finished loading 
class embed scalar embed::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class embed

// Script to be run when media data is loaded 
class embed scalar embed::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class embed

// Script to be run when meta data (like dimensions and duration) are loaded 
class embed scalar embed::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class embed

// Script to be run just as the file begins to load before anything is actually loaded 
class embed scalar embed::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class embed

// Script to be run when the message is triggered 
class embed scalar embed::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class embed

// Fires when a mouse button is pressed down on an element 
class embed scalar embed::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class embed

// Fires when the mouse pointer is moving while it is over an element 
class embed scalar embed::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class embed

// Fires when the mouse pointer moves out of an element 
class embed scalar embed::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class embed

// Fires when the mouse pointer moves over an element 
class embed scalar embed::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class embed

// Fires when a mouse button is released over an element 
class embed scalar embed::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class embed

// Deprecated. Use the onwheel attribute instead 
class embed scalar embed::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class embed

// Script to be run when the browser starts to work offline 
class embed scalar embed::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class embed

// Script to be run when the browser starts to work online 
class embed scalar embed::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class embed

// Script to be run when a user navigates away from a page 
class embed scalar embed::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class embed

// Script to be run when a user navigates to a page 
class embed scalar embed::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class embed

// Fires when the user pastes some content in an element 
class embed scalar embed::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class embed

// Script to be run when the media is paused either by the user or programmatically 
class embed scalar embed::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class embed

// Script to be run when the media is ready to start playing 
class embed scalar embed::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class embed

// Script to be run when the media actually has started playing 
class embed scalar embed::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class embed

// Script to be run when the window's history changes 
class embed scalar embed::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class embed

// Script to be run when the browser is in the process of getting the media data 
class embed scalar embed::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class embed

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class embed scalar embed::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class embed

// Fires when the Reset button in a form is clicked 
class embed scalar embed::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class embed

// Fires when the browser window is resized 
class embed scalar embed::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class embed

// Script to be run when an element's scrollbar is being scrolled 
class embed scalar embed::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class embed

// Fires when the user writes something in a search field (for <input="search">) 
class embed scalar embed::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class embed

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class embed scalar embed::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class embed

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class embed scalar embed::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class embed

// Fires after some text has been selected in an element 
class embed scalar embed::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class embed

// Fires when a <menu> element is shown as a context menu 
class embed scalar embed::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class embed

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class embed scalar embed::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class embed

// Script to be run when a Web Storage area is updated 
class embed scalar embed::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class embed

// Fires when a form is submitted 
class embed scalar embed::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class embed

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class embed scalar embed::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class embed

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class embed scalar embed::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class embed

// Fires when the user opens or closes the <details> element 
class embed scalar embed::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class embed

// Fires once a page has unloaded (or the browser window has been closed) 
class embed scalar embed::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class embed

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class embed scalar embed::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class embed

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class embed scalar embed::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class embed

// Fires when the mouse wheel rolls up or down over an element 
class embed scalar embed::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class embed

// Specifies whether the element is to have its spelling and grammar checked or not 
class embed scalar embed::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class embed
...
class embed scalar embed::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class embed

// Specifies the tabbing order of an element 
class embed scalar embed::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class embed

// Specifies extra information about an element 
class embed scalar embed::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class embed

// Specifies whether the content of an element should be translated or not 
class embed scalar embed::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class embed
...
string scalar embed::print() { 
    ...
    open = getOpens() + getAccesskey() + getClass() + getContenteditable() + getContextmenu() + getData() + getDir() + getDraggable() + getDropzone() + getHeight() + getHidden() + getId() + getLang() + getOnabort() + getOnafter + getOnbefore + getOnbeforeunload() + getOnblur() + getOncanplay() + getOncanplaythrough() + getOnchange() + getOnclick() + getOncontextmenu() + getOncopy() + getOncuechange() + getOncut() + getOndblclick() + getOndrag() + getOndragend() + getOndragenter() + getOndragleave() + getOndragover() + getOndragstart() + getOndrop() + getOndurationchange() + getOnemptied() + getOnended() + getOnerror() + getOnfocus() + getOnhashchange() + getOninput() + getOninvalid() + getOnkeydown() + getOnkeypress() + getOnkeyup() + getOnload() + getOnloadeddata() + getOnloadedmetadata() + getOnloadstart() + getOnmessage() + getOnmousedown() + getOnmousemove() + getOnmouseout() + getOnmouseover() + getOnmouseup() + getOnmousewheel() + getOnoffline() + getOnonline() + getOnpagehide() + getOnpageshow() + getOnpaste() + getOnpause() + getOnplay() + getOnplaying() + getOnpopstate() + getOnprogress() + getOnratechange() + getOnreset() + getOnresize() + getOnscroll() + getOnsearch() + getOnseeked() + getOnseeking() + getOnselect() + getOnshow() + getOnstalled() + getOnstorage() + getOnsubmit() + getOnsuspend() + getOntimeupdate() + getOntoggle() + getOnunload() + getOnvolumechange() + getOnwaiting() + getOnwheel() + getSpellcheck() + getSrc() + getStyle() + getTabindex() + getTitle() + getTranslate() + getType() + getWidth() + getOpene()
