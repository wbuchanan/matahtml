...
class embed { 
    ...
    string                                                       scalar                  accesskey, contenteditable, contextmenu, data, draggable, dropzone, height, hidden, htmlclass, htmldir, htmltranslate, htmltype, id, lang, onabort, onafterprint, onbeforeprint, onbeforeunload, onblur, oncanplay, oncanplaythrough, onchange, onclick, oncontextmenu, oncopy, oncuechange, oncut, ondblclick, ondrag, ondragend, ondragenter, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onerror, onfocus, onhashchange, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadstart, onmessage, onmousedown, onmousemove, onmouseout, onmouseover, onmouseup, onmousewheel, onoffline, ononline, onpagehide, onpageshow, onpaste, onpause, onplay, onplaying, onpopstate, onprogress, onratechange, onreset, onresize, onscroll, onsearch, onseeked, onseeking, onselect, onshow, onstalled, onstorage, onsubmit, onsuspend, ontimeupdate, ontoggle, onunload, onvolumechange, onwaiting, onwheel, spellcheck, src, style, tabindex, title, width
...
void embed::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class embed
...
void embed::set(| string scalar pixels) { 
...
void embed::set(| string scalar media_type) { 
...
void embed::set(| string scalar script) { 
...
void embed::set(| string scalar URL) { 
...
string scalar embed::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class embed
