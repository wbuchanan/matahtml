...
void dfn::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class dfn
...
void dfn::set(| string scalar script) { 
...
string scalar dfn::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class dfn
