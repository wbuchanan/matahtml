...
void del::set(| string scalar methodarg) { 
...
void del::set(| string scalar YYYY-MM-DDThh:mm:ssTZD) { 

    // Declare member variables based on arguments 
    string scalar locYYYY-MM-DDThh:mm:ssTZD 

    // Initialize the local variable 1
    locYYYY-MM-DDThh:mm:ssTZD = `" = ""' + YYYY-MM-DDThh:mm:ssTZD + `"""' 

    // Set the attribute  for this class 
    this. = locYYYY-MM-DDThh:mm:ssTZD
...
void del::set(| string scalar script) { 
...
string scalar del::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class del
