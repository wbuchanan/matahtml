...
void mark::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class mark
...
void mark::set(| string scalar script) { 
...
string scalar mark::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class mark
