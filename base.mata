...
void base::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class base
...
void base::set(| string scalar URL) { 
...
void base::set(| string scalar script) { 
...
void base::set(| string scalar _blank, string scalar _parent, string scalar _self, string scalar _top, string scalar framename) { 
...
string scalar base::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class base
