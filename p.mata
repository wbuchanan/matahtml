...
void p::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class p

// Not supported in HTML5. Specifies the alignment of the text within a paragraph 
void p::set(| string scalar left, string scalar right, string scalar center, string scalar justify) { 
...
void p::set(| string scalar script) { 
...
} // End of getter method for  member of class p
