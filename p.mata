...
class p scalar p::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class p
...
class p scalar p::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class p

// Specifies whether the content of an element is editable or not 
class p scalar p::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class p

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class p scalar p::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class p

// Used to store custom data private to the page or application 
class p scalar p::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class p

// Specifies the text direction for the content in an element 
class p scalar p::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class p

// Specifies whether an element is draggable or not 
class p scalar p::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class p

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class p scalar p::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class p

// Specifies that an element is not yet, or is no longer, relevant 
class p scalar p::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class p

// Specifies a unique id for an element 
class p scalar p::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class p

// Specifies the language of the element's content 
class p scalar p::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class p

// Script to be run on abort 
class p scalar p::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class p

// Script to be run after the document is printed 
class p scalar p::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class p

// Script to be run before the document is printed 
class p scalar p::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class p

// Script to be run when the document is about to be unloaded 
class p scalar p::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class p

// Fires the moment that the element loses focus 
class p scalar p::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class p

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class p scalar p::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class p

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class p scalar p::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class p

// Fires the moment when the value of the element is changed 
class p scalar p::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class p

// Fires on a mouse click on the element 
class p scalar p::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class p

// Script to be run when a context menu is triggered 
class p scalar p::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class p

// Fires when the user copies the content of an element 
class p scalar p::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class p

// Script to be run when the cue changes in a <track> element 
class p scalar p::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class p

// Fires when the user cuts the content of an element 
class p scalar p::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class p

// Fires on a mouse double-click on the element 
class p scalar p::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class p

// Script to be run when an element is dragged 
class p scalar p::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class p

// Script to be run at the end of a drag operation 
class p scalar p::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class p

// Script to be run when an element has been dragged to a valid drop target 
class p scalar p::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class p

// Script to be run when an element leaves a valid drop target 
class p scalar p::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class p

// Script to be run when an element is being dragged over a valid drop target 
class p scalar p::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class p

// Script to be run at the start of a drag operation 
class p scalar p::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class p

// Script to be run when dragged element is being dropped 
class p scalar p::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class p

// Script to be run when the length of the media changes 
class p scalar p::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class p

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class p scalar p::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class p

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class p scalar p::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class p

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class p scalar p::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class p

// Fires the moment when the element gets focus 
class p scalar p::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class p

// Script to be run when there has been changes to the anchor part of the a URL 
class p scalar p::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class p

// Script to be run when an element gets user input 
class p scalar p::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class p

// Script to be run when an element is invalid 
class p scalar p::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class p

// Fires when a user is pressing a key 
class p scalar p::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class p

// Fires when a user presses a key 
class p scalar p::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class p

// Fires when a user releases a key 
class p scalar p::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class p

// Fires after the page is finished loading 
class p scalar p::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class p

// Script to be run when media data is loaded 
class p scalar p::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class p

// Script to be run when meta data (like dimensions and duration) are loaded 
class p scalar p::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class p

// Script to be run just as the file begins to load before anything is actually loaded 
class p scalar p::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class p

// Script to be run when the message is triggered 
class p scalar p::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class p

// Fires when a mouse button is pressed down on an element 
class p scalar p::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class p

// Fires when the mouse pointer is moving while it is over an element 
class p scalar p::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class p

// Fires when the mouse pointer moves out of an element 
class p scalar p::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class p

// Fires when the mouse pointer moves over an element 
class p scalar p::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class p

// Fires when a mouse button is released over an element 
class p scalar p::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class p

// Deprecated. Use the onwheel attribute instead 
class p scalar p::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class p

// Script to be run when the browser starts to work offline 
class p scalar p::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class p

// Script to be run when the browser starts to work online 
class p scalar p::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class p

// Script to be run when a user navigates away from a page 
class p scalar p::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class p

// Script to be run when a user navigates to a page 
class p scalar p::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class p

// Fires when the user pastes some content in an element 
class p scalar p::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class p

// Script to be run when the media is paused either by the user or programmatically 
class p scalar p::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class p

// Script to be run when the media is ready to start playing 
class p scalar p::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class p

// Script to be run when the media actually has started playing 
class p scalar p::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class p

// Script to be run when the window's history changes 
class p scalar p::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class p

// Script to be run when the browser is in the process of getting the media data 
class p scalar p::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class p

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class p scalar p::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class p

// Fires when the Reset button in a form is clicked 
class p scalar p::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class p

// Fires when the browser window is resized 
class p scalar p::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class p

// Script to be run when an element's scrollbar is being scrolled 
class p scalar p::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class p

// Fires when the user writes something in a search field (for <input="search">) 
class p scalar p::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class p

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class p scalar p::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class p

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class p scalar p::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class p

// Fires after some text has been selected in an element 
class p scalar p::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class p

// Fires when a <menu> element is shown as a context menu 
class p scalar p::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class p

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class p scalar p::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class p

// Script to be run when a Web Storage area is updated 
class p scalar p::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class p

// Fires when a form is submitted 
class p scalar p::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class p

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class p scalar p::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class p

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class p scalar p::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class p

// Fires when the user opens or closes the <details> element 
class p scalar p::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class p

// Fires once a page has unloaded (or the browser window has been closed) 
class p scalar p::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class p

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class p scalar p::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class p

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class p scalar p::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class p

// Fires when the mouse wheel rolls up or down over an element 
class p scalar p::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class p

// Specifies whether the element is to have its spelling and grammar checked or not 
class p scalar p::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class p

// Specifies an inline CSS style for an element 
class p scalar p::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class p

// Specifies the tabbing order of an element 
class p scalar p::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class p

// Specifies extra information about an element 
class p scalar p::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class p

// Specifies whether the content of an element should be translated or not 
class p scalar p::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class p
