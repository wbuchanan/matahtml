...
void samp::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class samp
...
void samp::set(| string scalar script) { 
...
string scalar samp::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class samp
