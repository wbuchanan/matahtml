...
void cite::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class cite
...
void cite::set(| string scalar script) { 
...
string scalar cite::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class cite
