...
void time::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class time
...
void time::set(| string scalar datetime) { 

    // Declare member variables based on arguments 
    string scalar locdatetime 
...
void time::set(| string scalar script) { 
...
} // End of getter method for  member of class time
