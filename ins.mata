...
void ins::set(| string scalar methodarg) { 
...
void ins::set(| string scalar YYYY-MM-DDThh:mm:ssTZD) { 
...
void ins::set(| string scalar script) { 
...
string scalar ins::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class ins
