...
class body { 
    ...
    string                                                       scalar                  accesskey, alink, background, bgcolor, contenteditable, contextmenu, data, draggable, dropzone, hidden, htmlclass, htmldir, htmltranslate, id, lang, link, onabort, onafterprint, onbeforeprint, onbeforeunload, onblur, oncanplay, oncanplaythrough, onchange, onclick, oncontextmenu, oncopy, oncuechange, oncut, ondblclick, ondrag, ondragend, ondragenter, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onerror, onfocus, onhashchange, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadstart, onmessage, onmousedown, onmousemove, onmouseout, onmouseover, onmouseup, onmousewheel, onoffline, ononline, onpagehide, onpageshow, onpaste, onpause, onplay, onplaying, onpopstate, onprogress, onratechange, onreset, onresize, onscroll, onsearch, onseeked, onseeking, onselect, onshow, onstalled, onstorage, onsubmit, onsuspend, ontimeupdate, ontoggle, onunload, onvolumechange, onwaiting, onwheel, spellcheck, style, tabindex, text, title, vlink
...
void body::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class body

// Not supported in HTML5. Specifies the color of an active link in a document 
void body::set(| string scalar color) { 

    // Declare member variables based on arguments 
    string scalar loccolor 
...
void body::set(| string scalar URL) { 
...
void body::set(| string scalar script) { 
...
string scalar body::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class body
