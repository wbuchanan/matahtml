...
class body { 
    ...
    string               scalar          htmlaccesskey, htmlalink, htmlbackground, htmlbgcolor, htmlclass, htmlcontenteditable, htmlcontextmenu, htmldata, htmldir, htmldraggable, htmldropzone, htmlhidden, htmlid, htmllang, htmllink, htmlonabort, htmlonafterprint, htmlonbeforeprint, htmlonbeforeunload, htmlonblur, htmloncanplay, htmloncanplaythrough, htmlonchange, htmlonclick, htmloncontextmenu, htmloncopy, htmloncuechange, htmloncut, htmlondblclick, htmlondrag, htmlondragend, htmlondragenter, htmlondragleave, htmlondragover, htmlondragstart, htmlondrop, htmlondurationchange, htmlonemptied, htmlonended, htmlonerror, htmlonfocus, htmlonhashchange, htmloninput, htmloninvalid, htmlonkeydown, htmlonkeypress, htmlonkeyup, htmlonload, htmlonloadeddata, htmlonloadedmetadata, htmlonloadstart, htmlonmessage, htmlonmousedown, htmlonmousemove, htmlonmouseout, htmlonmouseover, htmlonmouseup, htmlonmousewheel, htmlonoffline, htmlononline, htmlonpagehide, htmlonpageshow, htmlonpaste, htmlonpause, htmlonplay, htmlonplaying, htmlonpopstate, htmlonprogress, htmlonratechange, htmlonreset, htmlonresize, htmlonscroll, htmlonsearch, htmlonseeked, htmlonseeking, htmlonselect, htmlonshow, htmlonstalled, htmlonstorage, htmlonsubmit, htmlonsuspend, htmlontimeupdate, htmlontoggle, htmlonunload, htmlonvolumechange, htmlonwaiting, htmlonwheel, htmlspellcheck, htmlstyle, htmltabindex, htmltext, htmltitle, htmltranslate, htmlvlink
    ...
    // Setter methods 
    class        body     scalar  setClassArgs(), setAccesskey(), setAlink(), setBackground(), setBgcolor(), setClass(), setContenteditable(), setContextmenu(), setData(), setDir(), setDraggable(), setDropzone(), setHidden(), setId(), setLang(), setLink(), setOnabort(), setOnafterprint(), setOnbeforeprint(), setOnbeforeunload(), setOnblur(), setOncanplay(), setOncanplaythrough(), setOnchange(), setOnclick(), setOncontextmenu(), setOncopy(), setOncuechange(), setOncut(), setOndblclick(), setOndrag(), setOndragend(), setOndragenter(), setOndragleave(), setOndragover(), setOndragstart(), setOndrop(), setOndurationchange(), setOnemptied(), setOnended(), setOnerror(), setOnfocus(), setOnhashchange(), setOninput(), setOninvalid(), setOnkeydown(), setOnkeypress(), setOnkeyup(), setOnload(), setOnloadeddata(), setOnloadedmetadata(), setOnloadstart(), setOnmessage(), setOnmousedown(), setOnmousemove(), setOnmouseout(), setOnmouseover(), setOnmouseup(), setOnmousewheel(), setOnoffline(), setOnonline(), setOnpagehide(), setOnpageshow(), setOnpaste(), setOnpause(), setOnplay(), setOnplaying(), setOnpopstate(), setOnprogress(), setOnratechange(), setOnreset(), setOnresize(), setOnscroll(), setOnsearch(), setOnseeked(), setOnseeking(), setOnselect(), setOnshow(), setOnstalled(), setOnstorage(), setOnsubmit(), setOnsuspend(), setOntimeupdate(), setOntoggle(), setOnunload(), setOnvolumechange(), setOnwaiting(), setOnwheel(), setSpellcheck(), setStyle(), setTabindex(), setText(), setTitle(), setTranslate(), setVlink()

    // Getter methods 
    string               scalar          getOpens(), getOpene(), getClose(), print(), getClassArgs(), getAccesskey(), getAlink(), getBackground(), getBgcolor(), getClass(), getContenteditable(), getContextmenu(), getData(), getDir(), getDraggable(), getDropzone(), getHidden(), getId(), getLang(), getLink(), getOnabort(), getOnafterprint(), getOnbeforeprint(), getOnbeforeunload(), getOnblur(), getOncanplay(), getOncanplaythrough(), getOnchange(), getOnclick(), getOncontextmenu(), getOncopy(), getOncuechange(), getOncut(), getOndblclick(), getOndrag(), getOndragend(), getOndragenter(), getOndragleave(), getOndragover(), getOndragstart(), getOndrop(), getOndurationchange(), getOnemptied(), getOnended(), getOnerror(), getOnfocus(), getOnhashchange(), getOninput(), getOninvalid(), getOnkeydown(), getOnkeypress(), getOnkeyup(), getOnload(), getOnloadeddata(), getOnloadedmetadata(), getOnloadstart(), getOnmessage(), getOnmousedown(), getOnmousemove(), getOnmouseout(), getOnmouseover(), getOnmouseup(), getOnmousewheel(), getOnoffline(), getOnonline(), getOnpagehide(), getOnpageshow(), getOnpaste(), getOnpause(), getOnplay(), getOnplaying(), getOnpopstate(), getOnprogress(), getOnratechange(), getOnreset(), getOnresize(), getOnscroll(), getOnsearch(), getOnseeked(), getOnseeking(), getOnselect(), getOnshow(), getOnstalled(), getOnstorage(), getOnsubmit(), getOnsuspend(), getOntimeupdate(), getOntoggle(), getOnunload(), getOnvolumechange(), getOnwaiting(), getOnwheel(), getSpellcheck(), getStyle(), getTabindex(), getText(), getTitle(), getTranslate(), getVlink()
...
class body scalar body::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class body
...
class body scalar body::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class body

// Specifies whether the content of an element is editable or not 
class body scalar body::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class body

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class body scalar body::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class body

// Used to store custom data private to the page or application 
class body scalar body::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class body

// Specifies the text direction for the content in an element 
class body scalar body::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class body

// Specifies whether an element is draggable or not 
class body scalar body::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class body

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class body scalar body::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class body

// Specifies that an element is not yet, or is no longer, relevant 
class body scalar body::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class body

// Specifies a unique id for an element 
class body scalar body::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class body

// Specifies the language of the element's content 
class body scalar body::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class body
...
class body scalar body::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class body

// Script to be run after the document is printed 
class body scalar body::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class body

// Script to be run before the document is printed 
class body scalar body::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class body

// Script to be run when the document is about to be unloaded 
class body scalar body::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class body

// Fires the moment that the element loses focus 
class body scalar body::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class body

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class body scalar body::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class body

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class body scalar body::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class body

// Fires the moment when the value of the element is changed 
class body scalar body::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class body

// Fires on a mouse click on the element 
class body scalar body::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class body

// Script to be run when a context menu is triggered 
class body scalar body::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class body

// Fires when the user copies the content of an element 
class body scalar body::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class body

// Script to be run when the cue changes in a <track> element 
class body scalar body::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class body

// Fires when the user cuts the content of an element 
class body scalar body::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class body

// Fires on a mouse double-click on the element 
class body scalar body::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class body

// Script to be run when an element is dragged 
class body scalar body::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class body

// Script to be run at the end of a drag operation 
class body scalar body::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class body

// Script to be run when an element has been dragged to a valid drop target 
class body scalar body::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class body

// Script to be run when an element leaves a valid drop target 
class body scalar body::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class body

// Script to be run when an element is being dragged over a valid drop target 
class body scalar body::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class body

// Script to be run at the start of a drag operation 
class body scalar body::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class body

// Script to be run when dragged element is being dropped 
class body scalar body::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class body

// Script to be run when the length of the media changes 
class body scalar body::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class body

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class body scalar body::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class body

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class body scalar body::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class body

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class body scalar body::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class body

// Fires the moment when the element gets focus 
class body scalar body::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class body

// Script to be run when there has been changes to the anchor part of the a URL 
class body scalar body::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class body

// Script to be run when an element gets user input 
class body scalar body::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class body

// Script to be run when an element is invalid 
class body scalar body::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class body

// Fires when a user is pressing a key 
class body scalar body::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class body

// Fires when a user presses a key 
class body scalar body::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class body

// Fires when a user releases a key 
class body scalar body::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class body

// Fires after the page is finished loading 
class body scalar body::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class body

// Script to be run when media data is loaded 
class body scalar body::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class body

// Script to be run when meta data (like dimensions and duration) are loaded 
class body scalar body::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class body

// Script to be run just as the file begins to load before anything is actually loaded 
class body scalar body::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class body

// Script to be run when the message is triggered 
class body scalar body::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class body

// Fires when a mouse button is pressed down on an element 
class body scalar body::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class body

// Fires when the mouse pointer is moving while it is over an element 
class body scalar body::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class body

// Fires when the mouse pointer moves out of an element 
class body scalar body::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class body

// Fires when the mouse pointer moves over an element 
class body scalar body::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class body

// Fires when a mouse button is released over an element 
class body scalar body::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class body

// Deprecated. Use the onwheel attribute instead 
class body scalar body::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class body

// Script to be run when the browser starts to work offline 
class body scalar body::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class body

// Script to be run when the browser starts to work online 
class body scalar body::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class body

// Script to be run when a user navigates away from a page 
class body scalar body::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class body

// Script to be run when a user navigates to a page 
class body scalar body::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class body

// Fires when the user pastes some content in an element 
class body scalar body::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class body

// Script to be run when the media is paused either by the user or programmatically 
class body scalar body::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class body

// Script to be run when the media is ready to start playing 
class body scalar body::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class body

// Script to be run when the media actually has started playing 
class body scalar body::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class body

// Script to be run when the window's history changes 
class body scalar body::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class body

// Script to be run when the browser is in the process of getting the media data 
class body scalar body::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class body

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class body scalar body::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class body

// Fires when the Reset button in a form is clicked 
class body scalar body::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class body

// Fires when the browser window is resized 
class body scalar body::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class body

// Script to be run when an element's scrollbar is being scrolled 
class body scalar body::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class body

// Fires when the user writes something in a search field (for <input="search">) 
class body scalar body::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class body

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class body scalar body::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class body

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class body scalar body::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class body

// Fires after some text has been selected in an element 
class body scalar body::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class body

// Fires when a <menu> element is shown as a context menu 
class body scalar body::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class body

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class body scalar body::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class body

// Script to be run when a Web Storage area is updated 
class body scalar body::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class body

// Fires when a form is submitted 
class body scalar body::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class body

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class body scalar body::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class body

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class body scalar body::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class body

// Fires when the user opens or closes the <details> element 
class body scalar body::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class body

// Fires once a page has unloaded (or the browser window has been closed) 
class body scalar body::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class body

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class body scalar body::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class body

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class body scalar body::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class body

// Fires when the mouse wheel rolls up or down over an element 
class body scalar body::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class body

// Specifies whether the element is to have its spelling and grammar checked or not 
class body scalar body::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class body

// Specifies an inline CSS style for an element 
class body scalar body::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class body

// Specifies the tabbing order of an element 
class body scalar body::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class body
...
class body scalar body::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class body

// Specifies whether the content of an element should be translated or not 
class body scalar body::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class body
...
string scalar body::print() { 
    ...
    open = getOpens() + getAccesskey() + getAlink() + getBackground() + getBgcolor() + getClass() + getContenteditable() + getContextmenu() + getData() + getDir() + getDraggable() + getDropzone() + getHidden() + getId() + getLang() + getLink() + getOnabort() + getOnafter + getOnbefore + getOnbeforeunload() + getOnblur() + getOncanplay() + getOncanplaythrough() + getOnchange() + getOnclick() + getOncontextmenu() + getOncopy() + getOncuechange() + getOncut() + getOndblclick() + getOndrag() + getOndragend() + getOndragenter() + getOndragleave() + getOndragover() + getOndragstart() + getOndrop() + getOndurationchange() + getOnemptied() + getOnended() + getOnerror() + getOnfocus() + getOnhashchange() + getOninput() + getOninvalid() + getOnkeydown() + getOnkeypress() + getOnkeyup() + getOnload() + getOnloadeddata() + getOnloadedmetadata() + getOnloadstart() + getOnmessage() + getOnmousedown() + getOnmousemove() + getOnmouseout() + getOnmouseover() + getOnmouseup() + getOnmousewheel() + getOnoffline() + getOnonline() + getOnpagehide() + getOnpageshow() + getOnpaste() + getOnpause() + getOnplay() + getOnplaying() + getOnpopstate() + getOnprogress() + getOnratechange() + getOnreset() + getOnresize() + getOnscroll() + getOnsearch() + getOnseeked() + getOnseeking() + getOnselect() + getOnshow() + getOnstalled() + getOnstorage() + getOnsubmit() + getOnsuspend() + getOntimeupdate() + getOntoggle() + getOnunload() + getOnvolumechange() + getOnwaiting() + getOnwheel() + getSpellcheck() + getStyle() + getTabindex() + getText() + getTitle() + getTranslate() + getVlink() + getOpene()
