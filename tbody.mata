...
void tbody::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class tbody

// Not supported in HTML5.Aligns the content inside the <tbody> element 
void tbody::set(| string scalar right, string scalar left, string scalar center, string scalar justify, string scalar char) { 
...
void tbody::set(| string scalar character) { 
...
void tbody::set(| string scalar number) { 
...
void tbody::set(| string scalar script) { 
...
void tbody::set(| string scalar top, string scalar middle, string scalar bottom, string scalar baseline) { 
...
string scalar tbody::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class tbody
