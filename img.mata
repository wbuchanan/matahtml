...
class img { 
    ...
    string               scalar          htmlaccesskey, htmlalign, htmlalt, htmlborder, htmlclass, htmlcontenteditable, htmlcontextmenu, htmlcrossorigin, htmldata, htmldir, htmldraggable, htmldropzone, htmlheight, htmlhidden, htmlhspace, htmlid, htmlismap, htmllang, htmllongdesc, htmlonabort, htmlonafterprint, htmlonbeforeprint, htmlonbeforeunload, htmlonblur, htmloncanplay, htmloncanplaythrough, htmlonchange, htmlonclick, htmloncontextmenu, htmloncopy, htmloncuechange, htmloncut, htmlondblclick, htmlondrag, htmlondragend, htmlondragenter, htmlondragleave, htmlondragover, htmlondragstart, htmlondrop, htmlondurationchange, htmlonemptied, htmlonended, htmlonerror, htmlonfocus, htmlonhashchange, htmloninput, htmloninvalid, htmlonkeydown, htmlonkeypress, htmlonkeyup, htmlonload, htmlonloadeddata, htmlonloadedmetadata, htmlonloadstart, htmlonmessage, htmlonmousedown, htmlonmousemove, htmlonmouseout, htmlonmouseover, htmlonmouseup, htmlonmousewheel, htmlonoffline, htmlononline, htmlonpagehide, htmlonpageshow, htmlonpaste, htmlonpause, htmlonplay, htmlonplaying, htmlonpopstate, htmlonprogress, htmlonratechange, htmlonreset, htmlonresize, htmlonscroll, htmlonsearch, htmlonseeked, htmlonseeking, htmlonselect, htmlonshow, htmlonstalled, htmlonstorage, htmlonsubmit, htmlonsuspend, htmlontimeupdate, htmlontoggle, htmlonunload, htmlonvolumechange, htmlonwaiting, htmlonwheel, htmlspellcheck, htmlsrc, htmlstyle, htmltabindex, htmltitle, htmltranslate, htmlusemap, htmlvspace, htmlwidth
    ...
    // Setter methods 
    class        img     scalar  setClassArgs(), setAccesskey(), setAlign(), setAlt(), setBorder(), setClass(), setContenteditable(), setContextmenu(), setCrossorigin(), setData(), setDir(), setDraggable(), setDropzone(), setHeight(), setHidden(), setHspace(), setId(), setIsmap(), setLang(), setLongdesc(), setOnabort(), setOnafterprint(), setOnbeforeprint(), setOnbeforeunload(), setOnblur(), setOncanplay(), setOncanplaythrough(), setOnchange(), setOnclick(), setOncontextmenu(), setOncopy(), setOncuechange(), setOncut(), setOndblclick(), setOndrag(), setOndragend(), setOndragenter(), setOndragleave(), setOndragover(), setOndragstart(), setOndrop(), setOndurationchange(), setOnemptied(), setOnended(), setOnerror(), setOnfocus(), setOnhashchange(), setOninput(), setOninvalid(), setOnkeydown(), setOnkeypress(), setOnkeyup(), setOnload(), setOnloadeddata(), setOnloadedmetadata(), setOnloadstart(), setOnmessage(), setOnmousedown(), setOnmousemove(), setOnmouseout(), setOnmouseover(), setOnmouseup(), setOnmousewheel(), setOnoffline(), setOnonline(), setOnpagehide(), setOnpageshow(), setOnpaste(), setOnpause(), setOnplay(), setOnplaying(), setOnpopstate(), setOnprogress(), setOnratechange(), setOnreset(), setOnresize(), setOnscroll(), setOnsearch(), setOnseeked(), setOnseeking(), setOnselect(), setOnshow(), setOnstalled(), setOnstorage(), setOnsubmit(), setOnsuspend(), setOntimeupdate(), setOntoggle(), setOnunload(), setOnvolumechange(), setOnwaiting(), setOnwheel(), setSpellcheck(), setSrc(), setStyle(), setTabindex(), setTitle(), setTranslate(), setUsemap(), setVspace(), setWidth()

    // Getter methods 
    string               scalar          getOpens(), getOpene(), getClose(), print(), getClassArgs(), getAccesskey(), getAlign(), getAlt(), getBorder(), getClass(), getContenteditable(), getContextmenu(), getCrossorigin(), getData(), getDir(), getDraggable(), getDropzone(), getHeight(), getHidden(), getHspace(), getId(), getIsmap(), getLang(), getLongdesc(), getOnabort(), getOnafterprint(), getOnbeforeprint(), getOnbeforeunload(), getOnblur(), getOncanplay(), getOncanplaythrough(), getOnchange(), getOnclick(), getOncontextmenu(), getOncopy(), getOncuechange(), getOncut(), getOndblclick(), getOndrag(), getOndragend(), getOndragenter(), getOndragleave(), getOndragover(), getOndragstart(), getOndrop(), getOndurationchange(), getOnemptied(), getOnended(), getOnerror(), getOnfocus(), getOnhashchange(), getOninput(), getOninvalid(), getOnkeydown(), getOnkeypress(), getOnkeyup(), getOnload(), getOnloadeddata(), getOnloadedmetadata(), getOnloadstart(), getOnmessage(), getOnmousedown(), getOnmousemove(), getOnmouseout(), getOnmouseover(), getOnmouseup(), getOnmousewheel(), getOnoffline(), getOnonline(), getOnpagehide(), getOnpageshow(), getOnpaste(), getOnpause(), getOnplay(), getOnplaying(), getOnpopstate(), getOnprogress(), getOnratechange(), getOnreset(), getOnresize(), getOnscroll(), getOnsearch(), getOnseeked(), getOnseeking(), getOnselect(), getOnshow(), getOnstalled(), getOnstorage(), getOnsubmit(), getOnsuspend(), getOntimeupdate(), getOntoggle(), getOnunload(), getOnvolumechange(), getOnwaiting(), getOnwheel(), getSpellcheck(), getSrc(), getStyle(), getTabindex(), getTitle(), getTranslate(), getUsemap(), getVspace(), getWidth()
...
class img scalar img::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class img
...
class img scalar img::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class img

// Specifies whether the content of an element is editable or not 
class img scalar img::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class img

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class img scalar img::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class img
...
class img scalar img::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class img

// Specifies the text direction for the content in an element 
class img scalar img::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class img

// Specifies whether an element is draggable or not 
class img scalar img::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class img

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class img scalar img::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class img
...
class img scalar img::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class img
...
class img scalar img::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class img
...
class img scalar img::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class img
...
class img scalar img::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class img

// Script to be run after the document is printed 
class img scalar img::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class img

// Script to be run before the document is printed 
class img scalar img::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class img

// Script to be run when the document is about to be unloaded 
class img scalar img::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class img

// Fires the moment that the element loses focus 
class img scalar img::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class img

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class img scalar img::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class img

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class img scalar img::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class img

// Fires the moment when the value of the element is changed 
class img scalar img::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class img

// Fires on a mouse click on the element 
class img scalar img::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class img

// Script to be run when a context menu is triggered 
class img scalar img::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class img

// Fires when the user copies the content of an element 
class img scalar img::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class img

// Script to be run when the cue changes in a <track> element 
class img scalar img::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class img

// Fires when the user cuts the content of an element 
class img scalar img::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class img

// Fires on a mouse double-click on the element 
class img scalar img::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class img

// Script to be run when an element is dragged 
class img scalar img::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class img

// Script to be run at the end of a drag operation 
class img scalar img::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class img

// Script to be run when an element has been dragged to a valid drop target 
class img scalar img::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class img

// Script to be run when an element leaves a valid drop target 
class img scalar img::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class img

// Script to be run when an element is being dragged over a valid drop target 
class img scalar img::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class img

// Script to be run at the start of a drag operation 
class img scalar img::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class img

// Script to be run when dragged element is being dropped 
class img scalar img::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class img

// Script to be run when the length of the media changes 
class img scalar img::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class img

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class img scalar img::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class img

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class img scalar img::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class img

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class img scalar img::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class img

// Fires the moment when the element gets focus 
class img scalar img::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class img

// Script to be run when there has been changes to the anchor part of the a URL 
class img scalar img::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class img

// Script to be run when an element gets user input 
class img scalar img::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class img

// Script to be run when an element is invalid 
class img scalar img::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class img

// Fires when a user is pressing a key 
class img scalar img::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class img

// Fires when a user presses a key 
class img scalar img::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class img

// Fires when a user releases a key 
class img scalar img::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class img

// Fires after the page is finished loading 
class img scalar img::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class img

// Script to be run when media data is loaded 
class img scalar img::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class img

// Script to be run when meta data (like dimensions and duration) are loaded 
class img scalar img::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class img

// Script to be run just as the file begins to load before anything is actually loaded 
class img scalar img::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class img

// Script to be run when the message is triggered 
class img scalar img::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class img

// Fires when a mouse button is pressed down on an element 
class img scalar img::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class img

// Fires when the mouse pointer is moving while it is over an element 
class img scalar img::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class img

// Fires when the mouse pointer moves out of an element 
class img scalar img::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class img

// Fires when the mouse pointer moves over an element 
class img scalar img::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class img

// Fires when a mouse button is released over an element 
class img scalar img::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class img

// Deprecated. Use the onwheel attribute instead 
class img scalar img::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class img

// Script to be run when the browser starts to work offline 
class img scalar img::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class img

// Script to be run when the browser starts to work online 
class img scalar img::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class img

// Script to be run when a user navigates away from a page 
class img scalar img::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class img

// Script to be run when a user navigates to a page 
class img scalar img::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class img

// Fires when the user pastes some content in an element 
class img scalar img::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class img

// Script to be run when the media is paused either by the user or programmatically 
class img scalar img::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class img

// Script to be run when the media is ready to start playing 
class img scalar img::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class img

// Script to be run when the media actually has started playing 
class img scalar img::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class img

// Script to be run when the window's history changes 
class img scalar img::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class img

// Script to be run when the browser is in the process of getting the media data 
class img scalar img::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class img

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class img scalar img::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class img

// Fires when the Reset button in a form is clicked 
class img scalar img::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class img

// Fires when the browser window is resized 
class img scalar img::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class img

// Script to be run when an element's scrollbar is being scrolled 
class img scalar img::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class img

// Fires when the user writes something in a search field (for <input="search">) 
class img scalar img::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class img

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class img scalar img::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class img

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class img scalar img::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class img

// Fires after some text has been selected in an element 
class img scalar img::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class img

// Fires when a <menu> element is shown as a context menu 
class img scalar img::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class img

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class img scalar img::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class img

// Script to be run when a Web Storage area is updated 
class img scalar img::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class img

// Fires when a form is submitted 
class img scalar img::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class img

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class img scalar img::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class img

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class img scalar img::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class img

// Fires when the user opens or closes the <details> element 
class img scalar img::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class img

// Fires once a page has unloaded (or the browser window has been closed) 
class img scalar img::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class img

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class img scalar img::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class img

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class img scalar img::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class img

// Fires when the mouse wheel rolls up or down over an element 
class img scalar img::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class img

// Specifies whether the element is to have its spelling and grammar checked or not 
class img scalar img::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class img
...
class img scalar img::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class img

// Specifies the tabbing order of an element 
class img scalar img::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class img

// Specifies extra information about an element 
class img scalar img::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class img

// Specifies whether the content of an element should be translated or not 
class img scalar img::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class img
...
string scalar img::print() { 
    ...
    open = getOpens() + getAccesskey() + getAlign() + getAlt() + getBorder() + getClass() + getContenteditable() + getContextmenu() + getCrossorigin() + getData() + getDir() + getDraggable() + getDropzone() + getHeight() + getHidden() + getHspace() + getId() + getIsmap() + getLang() + getLongdesc() + getOnabort() + getOnafter + getOnbefore + getOnbeforeunload() + getOnblur() + getOncanplay() + getOncanplaythrough() + getOnchange() + getOnclick() + getOncontextmenu() + getOncopy() + getOncuechange() + getOncut() + getOndblclick() + getOndrag() + getOndragend() + getOndragenter() + getOndragleave() + getOndragover() + getOndragstart() + getOndrop() + getOndurationchange() + getOnemptied() + getOnended() + getOnerror() + getOnfocus() + getOnhashchange() + getOninput() + getOninvalid() + getOnkeydown() + getOnkeypress() + getOnkeyup() + getOnload() + getOnloadeddata() + getOnloadedmetadata() + getOnloadstart() + getOnmessage() + getOnmousedown() + getOnmousemove() + getOnmouseout() + getOnmouseover() + getOnmouseup() + getOnmousewheel() + getOnoffline() + getOnonline() + getOnpagehide() + getOnpageshow() + getOnpaste() + getOnpause() + getOnplay() + getOnplaying() + getOnpopstate() + getOnprogress() + getOnratechange() + getOnreset() + getOnresize() + getOnscroll() + getOnsearch() + getOnseeked() + getOnseeking() + getOnselect() + getOnshow() + getOnstalled() + getOnstorage() + getOnsubmit() + getOnsuspend() + getOntimeupdate() + getOntoggle() + getOnunload() + getOnvolumechange() + getOnwaiting() + getOnwheel() + getSpellcheck() + getSrc() + getStyle() + getTabindex() + getTitle() + getTranslate() + getUsemap() + getVspace() + getWidth() + getOpene()
