...
void dt::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class dt
...
void dt::set(| string scalar script) { 
...
string scalar dt::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class dt
