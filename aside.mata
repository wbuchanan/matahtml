...
void aside::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class aside
...
void aside::set(| string scalar script) { 
...
string scalar aside::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class aside
