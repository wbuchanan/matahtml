...
void dialog::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class dialog
...
void dialog::set(| string scalar script) { 
...
void dialog::set(| string scalar open) { 

    // Declare member variables based on arguments 
    string scalar locopen 
...
string scalar dialog::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class dialog
