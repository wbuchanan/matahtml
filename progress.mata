...
void progress::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class progress
...
void progress::set(| string scalar number) { 
...
void progress::set(| string scalar script) { 
...
string scalar progress::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class progress
