...
void code::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class code
...
void code::set(| string scalar script) { 
...
string scalar code::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class code
