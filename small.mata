...
void small::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class small
...
void small::set(| string scalar script) { 
...
string scalar small::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class small
