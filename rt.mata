...
void rt::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class rt
...
void rt::set(| string scalar script) { 
...
string scalar rt::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class rt
