...
void blockquote::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class blockquote

// Specifies the source of the quotation 
void blockquote::set(| string scalar URL) { 
...
void blockquote::set(| string scalar script) { 
...
string scalar blockquote::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class blockquote
