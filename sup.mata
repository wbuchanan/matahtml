...
void sup::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class sup
...
void sup::set(| string scalar script) { 
...
string scalar sup::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class sup
