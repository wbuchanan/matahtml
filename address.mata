...
void address::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class address
...
void address::set(| string scalar script) { 
...
string scalar address::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class address
