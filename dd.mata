...
void dd::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class dd
...
void dd::set(| string scalar script) { 
...
string scalar dd::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class dd
