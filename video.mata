...
class video { 
    ...
    string                                                       scalar                  accesskey, autoplay, contenteditable, contextmenu, controls, data, draggable, dropzone, height, hidden, htmlclass, htmldir, htmltranslate, id, lang, loop, muted, onabort, onafterprint, onbeforeprint, onbeforeunload, onblur, oncanplay, oncanplaythrough, onchange, onclick, oncontextmenu, oncopy, oncuechange, oncut, ondblclick, ondrag, ondragend, ondragenter, ondragleave, ondragover, ondragstart, ondrop, ondurationchange, onemptied, onended, onerror, onfocus, onhashchange, oninput, oninvalid, onkeydown, onkeypress, onkeyup, onload, onloadeddata, onloadedmetadata, onloadstart, onmessage, onmousedown, onmousemove, onmouseout, onmouseover, onmouseup, onmousewheel, onoffline, ononline, onpagehide, onpageshow, onpaste, onpause, onplay, onplaying, onpopstate, onprogress, onratechange, onreset, onresize, onscroll, onsearch, onseeked, onseeking, onselect, onshow, onstalled, onstorage, onsubmit, onsuspend, ontimeupdate, ontoggle, onunload, onvolumechange, onwaiting, onwheel, poster, preload, spellcheck, src, style, tabindex, title, width
...
void video::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class video

// Specifies that the video will start playing as soon as it is ready 
void video::set(| string scalar autoplay) { 

    // Declare member variables based on arguments 
    string scalar locautoplay 

    // Initialize the local variable 1
    locautoplay = `" = ""' + autoplay + `"""' 
...
void video::set(| string scalar controls) { 

    // Declare member variables based on arguments 
    string scalar loccontrols 

    // Initialize the local variable 1
    loccontrols = `" = ""' + controls + `"""' 
...
void video::set(| string scalar pixels) { 
...
void video::set(| string scalar loop) { 

    // Declare member variables based on arguments 
    string scalar locloop 
...
void video::set(| string scalar muted) { 

    // Declare member variables based on arguments 
    string scalar locmuted 
...
void video::set(| string scalar script) { 
...
void video::set(| string scalar URL) { 
...
void video::set(| string scalar auto, string scalar metadata, string scalar none) { 

    // Declare member variables based on arguments 
    string scalar locauto, "locmetadata", "locnone" 
    ...
    // Set the attribute  for this class 
    this. = locauto + "locmetadata" + "locnone"
...
string scalar video::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class video
