...
class source scalar source::setAccesskey(| string scalar methodarg) { 
...
} // End of Method accesskey declaration for class source

// Specifies one or more classnames for an element (refers to a class in a style sheet) 
class source scalar source::setClass(| string scalar methodarg) { 
...
} // End of Method class declaration for class source

// Specifies whether the content of an element is editable or not 
class source scalar source::setContenteditable(| string scalar methodarg) { 
...
} // End of Method contenteditable declaration for class source

// Specifies a context menu for an element. The context menu appears when a user right-clicks on the element 
class source scalar source::setContextmenu(| string scalar methodarg) { 
...
} // End of Method contextmenu declaration for class source

// Used to store custom data private to the page or application 
class source scalar source::setData(| string scalar methodarg) { 
...
} // End of Method data declaration for class source

// Specifies the text direction for the content in an element 
class source scalar source::setDir(| string scalar methodarg) { 
...
} // End of Method dir declaration for class source

// Specifies whether an element is draggable or not 
class source scalar source::setDraggable(| string scalar methodarg) { 
...
} // End of Method draggable declaration for class source

// Specifies whether the dragged data is copied, moved, or linked, when dropped 
class source scalar source::setDropzone(| string scalar methodarg) { 
...
} // End of Method dropzone declaration for class source

// Specifies that an element is not yet, or is no longer, relevant 
class source scalar source::setHidden(| string scalar methodarg) { 
...
} // End of Method hidden declaration for class source

// Specifies a unique id for an element 
class source scalar source::setId(| string scalar methodarg) { 
...
} // End of Method id declaration for class source

// Specifies the language of the element's content 
class source scalar source::setLang(| string scalar methodarg) { 
...
} // End of Method lang declaration for class source
...
class source scalar source::setOnabort(| string scalar methodarg) { 
...
} // End of Method onabort declaration for class source

// Script to be run after the document is printed 
class source scalar source::setOnafterprint(| string scalar methodarg) { 
...
} // End of Method onafterprint declaration for class source

// Script to be run before the document is printed 
class source scalar source::setOnbeforeprint(| string scalar methodarg) { 
...
} // End of Method onbeforeprint declaration for class source

// Script to be run when the document is about to be unloaded 
class source scalar source::setOnbeforeunload(| string scalar methodarg) { 
...
} // End of Method onbeforeunload declaration for class source

// Fires the moment that the element loses focus 
class source scalar source::setOnblur(| string scalar methodarg) { 
...
} // End of Method onblur declaration for class source

// Script to be run when a file is ready to start playing (when it has buffered enough to begin) 
class source scalar source::setOncanplay(| string scalar methodarg) { 
...
} // End of Method oncanplay declaration for class source

// Script to be run when a file can be played all the way to the end without pausing for buffering 
class source scalar source::setOncanplaythrough(| string scalar methodarg) { 
...
} // End of Method oncanplaythrough declaration for class source

// Fires the moment when the value of the element is changed 
class source scalar source::setOnchange(| string scalar methodarg) { 
...
} // End of Method onchange declaration for class source

// Fires on a mouse click on the element 
class source scalar source::setOnclick(| string scalar methodarg) { 
...
} // End of Method onclick declaration for class source

// Script to be run when a context menu is triggered 
class source scalar source::setOncontextmenu(| string scalar methodarg) { 
...
} // End of Method oncontextmenu declaration for class source

// Fires when the user copies the content of an element 
class source scalar source::setOncopy(| string scalar methodarg) { 
...
} // End of Method oncopy declaration for class source

// Script to be run when the cue changes in a <track> element 
class source scalar source::setOncuechange(| string scalar methodarg) { 
...
} // End of Method oncuechange declaration for class source

// Fires when the user cuts the content of an element 
class source scalar source::setOncut(| string scalar methodarg) { 
...
} // End of Method oncut declaration for class source

// Fires on a mouse double-click on the element 
class source scalar source::setOndblclick(| string scalar methodarg) { 
...
} // End of Method ondblclick declaration for class source

// Script to be run when an element is dragged 
class source scalar source::setOndrag(| string scalar methodarg) { 
...
} // End of Method ondrag declaration for class source

// Script to be run at the end of a drag operation 
class source scalar source::setOndragend(| string scalar methodarg) { 
...
} // End of Method ondragend declaration for class source

// Script to be run when an element has been dragged to a valid drop target 
class source scalar source::setOndragenter(| string scalar methodarg) { 
...
} // End of Method ondragenter declaration for class source

// Script to be run when an element leaves a valid drop target 
class source scalar source::setOndragleave(| string scalar methodarg) { 
...
} // End of Method ondragleave declaration for class source

// Script to be run when an element is being dragged over a valid drop target 
class source scalar source::setOndragover(| string scalar methodarg) { 
...
} // End of Method ondragover declaration for class source

// Script to be run at the start of a drag operation 
class source scalar source::setOndragstart(| string scalar methodarg) { 
...
} // End of Method ondragstart declaration for class source

// Script to be run when dragged element is being dropped 
class source scalar source::setOndrop(| string scalar methodarg) { 
...
} // End of Method ondrop declaration for class source

// Script to be run when the length of the media changes 
class source scalar source::setOndurationchange(| string scalar methodarg) { 
...
} // End of Method ondurationchange declaration for class source

// Script to be run when something bad happens and the file is suddenly unavailable (like unexpectedly disconnects) 
class source scalar source::setOnemptied(| string scalar methodarg) { 
...
} // End of Method onemptied declaration for class source

// Script to be run when the media has reach the end (a useful event for messages like "thanks for listening") 
class source scalar source::setOnended(| string scalar methodarg) { 
...
} // End of Method onended declaration for class source

// Fires when an error occurs while loading an external file Script to be run when an error occur Script to be run when an error occurs when the file is being loaded 
class source scalar source::setOnerror(| string scalar methodarg) { 
...
} // End of Method onerror declaration for class source

// Fires the moment when the element gets focus 
class source scalar source::setOnfocus(| string scalar methodarg) { 
...
} // End of Method onfocus declaration for class source

// Script to be run when there has been changes to the anchor part of the a URL 
class source scalar source::setOnhashchange(| string scalar methodarg) { 
...
} // End of Method onhashchange declaration for class source

// Script to be run when an element gets user input 
class source scalar source::setOninput(| string scalar methodarg) { 
...
} // End of Method oninput declaration for class source

// Script to be run when an element is invalid 
class source scalar source::setOninvalid(| string scalar methodarg) { 
...
} // End of Method oninvalid declaration for class source

// Fires when a user is pressing a key 
class source scalar source::setOnkeydown(| string scalar methodarg) { 
...
} // End of Method onkeydown declaration for class source

// Fires when a user presses a key 
class source scalar source::setOnkeypress(| string scalar methodarg) { 
...
} // End of Method onkeypress declaration for class source

// Fires when a user releases a key 
class source scalar source::setOnkeyup(| string scalar methodarg) { 
...
} // End of Method onkeyup declaration for class source

// Fires after the page is finished loading 
class source scalar source::setOnload(| string scalar methodarg) { 
...
} // End of Method onload declaration for class source

// Script to be run when media data is loaded 
class source scalar source::setOnloadeddata(| string scalar methodarg) { 
...
} // End of Method onloadeddata declaration for class source

// Script to be run when meta data (like dimensions and duration) are loaded 
class source scalar source::setOnloadedmetadata(| string scalar methodarg) { 
...
} // End of Method onloadedmetadata declaration for class source

// Script to be run just as the file begins to load before anything is actually loaded 
class source scalar source::setOnloadstart(| string scalar methodarg) { 
...
} // End of Method onloadstart declaration for class source

// Script to be run when the message is triggered 
class source scalar source::setOnmessage(| string scalar methodarg) { 
...
} // End of Method onmessage declaration for class source

// Fires when a mouse button is pressed down on an element 
class source scalar source::setOnmousedown(| string scalar methodarg) { 
...
} // End of Method onmousedown declaration for class source

// Fires when the mouse pointer is moving while it is over an element 
class source scalar source::setOnmousemove(| string scalar methodarg) { 
...
} // End of Method onmousemove declaration for class source

// Fires when the mouse pointer moves out of an element 
class source scalar source::setOnmouseout(| string scalar methodarg) { 
...
} // End of Method onmouseout declaration for class source

// Fires when the mouse pointer moves over an element 
class source scalar source::setOnmouseover(| string scalar methodarg) { 
...
} // End of Method onmouseover declaration for class source

// Fires when a mouse button is released over an element 
class source scalar source::setOnmouseup(| string scalar methodarg) { 
...
} // End of Method onmouseup declaration for class source

// Deprecated. Use the onwheel attribute instead 
class source scalar source::setOnmousewheel(| string scalar methodarg) { 
...
} // End of Method onmousewheel declaration for class source

// Script to be run when the browser starts to work offline 
class source scalar source::setOnoffline(| string scalar methodarg) { 
...
} // End of Method onoffline declaration for class source

// Script to be run when the browser starts to work online 
class source scalar source::setOnonline(| string scalar methodarg) { 
...
} // End of Method ononline declaration for class source

// Script to be run when a user navigates away from a page 
class source scalar source::setOnpagehide(| string scalar methodarg) { 
...
} // End of Method onpagehide declaration for class source

// Script to be run when a user navigates to a page 
class source scalar source::setOnpageshow(| string scalar methodarg) { 
...
} // End of Method onpageshow declaration for class source

// Fires when the user pastes some content in an element 
class source scalar source::setOnpaste(| string scalar methodarg) { 
...
} // End of Method onpaste declaration for class source

// Script to be run when the media is paused either by the user or programmatically 
class source scalar source::setOnpause(| string scalar methodarg) { 
...
} // End of Method onpause declaration for class source

// Script to be run when the media is ready to start playing 
class source scalar source::setOnplay(| string scalar methodarg) { 
...
} // End of Method onplay declaration for class source

// Script to be run when the media actually has started playing 
class source scalar source::setOnplaying(| string scalar methodarg) { 
...
} // End of Method onplaying declaration for class source

// Script to be run when the window's history changes 
class source scalar source::setOnpopstate(| string scalar methodarg) { 
...
} // End of Method onpopstate declaration for class source

// Script to be run when the browser is in the process of getting the media data 
class source scalar source::setOnprogress(| string scalar methodarg) { 
...
} // End of Method onprogress declaration for class source

// Script to be run each time the playback rate changes (like when a user switches to a slow motion or fast forward mode) 
class source scalar source::setOnratechange(| string scalar methodarg) { 
...
} // End of Method onratechange declaration for class source

// Fires when the Reset button in a form is clicked 
class source scalar source::setOnreset(| string scalar methodarg) { 
...
} // End of Method onreset declaration for class source

// Fires when the browser window is resized 
class source scalar source::setOnresize(| string scalar methodarg) { 
...
} // End of Method onresize declaration for class source

// Script to be run when an element's scrollbar is being scrolled 
class source scalar source::setOnscroll(| string scalar methodarg) { 
...
} // End of Method onscroll declaration for class source

// Fires when the user writes something in a search field (for <input="search">) 
class source scalar source::setOnsearch(| string scalar methodarg) { 
...
} // End of Method onsearch declaration for class source

// Script to be run when the seeking attribute is set to false indicating that seeking has ended 
class source scalar source::setOnseeked(| string scalar methodarg) { 
...
} // End of Method onseeked declaration for class source

// Script to be run when the seeking attribute is set to true indicating that seeking is active 
class source scalar source::setOnseeking(| string scalar methodarg) { 
...
} // End of Method onseeking declaration for class source

// Fires after some text has been selected in an element 
class source scalar source::setOnselect(| string scalar methodarg) { 
...
} // End of Method onselect declaration for class source

// Fires when a <menu> element is shown as a context menu 
class source scalar source::setOnshow(| string scalar methodarg) { 
...
} // End of Method onshow declaration for class source

// Script to be run when the browser is unable to fetch the media data for whatever reason 
class source scalar source::setOnstalled(| string scalar methodarg) { 
...
} // End of Method onstalled declaration for class source

// Script to be run when a Web Storage area is updated 
class source scalar source::setOnstorage(| string scalar methodarg) { 
...
} // End of Method onstorage declaration for class source

// Fires when a form is submitted 
class source scalar source::setOnsubmit(| string scalar methodarg) { 
...
} // End of Method onsubmit declaration for class source

// Script to be run when fetching the media data is stopped before it is completely loaded for whatever reason 
class source scalar source::setOnsuspend(| string scalar methodarg) { 
...
} // End of Method onsuspend declaration for class source

// Script to be run when the playing position has changed (like when the user fast forwards to a different point in the media) 
class source scalar source::setOntimeupdate(| string scalar methodarg) { 
...
} // End of Method ontimeupdate declaration for class source

// Fires when the user opens or closes the <details> element 
class source scalar source::setOntoggle(| string scalar methodarg) { 
...
} // End of Method ontoggle declaration for class source

// Fires once a page has unloaded (or the browser window has been closed) 
class source scalar source::setOnunload(| string scalar methodarg) { 
...
} // End of Method onunload declaration for class source

// Script to be run each time the volume is changed which (includes setting the volume to "mute") 
class source scalar source::setOnvolumechange(| string scalar methodarg) { 
...
} // End of Method onvolumechange declaration for class source

// Script to be run when the media has paused but is expected to resume (like when the media pauses to buffer more data) 
class source scalar source::setOnwaiting(| string scalar methodarg) { 
...
} // End of Method onwaiting declaration for class source

// Fires when the mouse wheel rolls up or down over an element 
class source scalar source::setOnwheel(| string scalar methodarg) { 
...
} // End of Method onwheel declaration for class source

// Specifies whether the element is to have its spelling and grammar checked or not 
class source scalar source::setSpellcheck(| string scalar methodarg) { 
...
} // End of Method spellcheck declaration for class source
...
class source scalar source::setStyle(| string scalar methodarg) { 
...
} // End of Method style declaration for class source

// Specifies the tabbing order of an element 
class source scalar source::setTabindex(| string scalar methodarg) { 
...
} // End of Method tabindex declaration for class source

// Specifies extra information about an element 
class source scalar source::setTitle(| string scalar methodarg) { 
...
} // End of Method title declaration for class source

// Specifies whether the content of an element should be translated or not 
class source scalar source::setTranslate(| string scalar methodarg) { 
...
} // End of Method translate declaration for class source
...
string scalar source::print() { 
    ...
    open = getOpens() + getAccesskey() + getClass() + getContenteditable() + getContextmenu() + getData() + getDir() + getDraggable() + getDropzone() + getHidden() + getId() + getLang() + getMedia() + getOnabort() + getOnafter + getOnbefore + getOnbeforeunload() + getOnblur() + getOncanplay() + getOncanplaythrough() + getOnchange() + getOnclick() + getOncontextmenu() + getOncopy() + getOncuechange() + getOncut() + getOndblclick() + getOndrag() + getOndragend() + getOndragenter() + getOndragleave() + getOndragover() + getOndragstart() + getOndrop() + getOndurationchange() + getOnemptied() + getOnended() + getOnerror() + getOnfocus() + getOnhashchange() + getOninput() + getOninvalid() + getOnkeydown() + getOnkeypress() + getOnkeyup() + getOnload() + getOnloadeddata() + getOnloadedmetadata() + getOnloadstart() + getOnmessage() + getOnmousedown() + getOnmousemove() + getOnmouseout() + getOnmouseover() + getOnmouseup() + getOnmousewheel() + getOnoffline() + getOnonline() + getOnpagehide() + getOnpageshow() + getOnpaste() + getOnpause() + getOnplay() + getOnplaying() + getOnpopstate() + getOnprogress() + getOnratechange() + getOnreset() + getOnresize() + getOnscroll() + getOnsearch() + getOnseeked() + getOnseeking() + getOnselect() + getOnshow() + getOnstalled() + getOnstorage() + getOnsubmit() + getOnsuspend() + getOntimeupdate() + getOntoggle() + getOnunload() + getOnvolumechange() + getOnwaiting() + getOnwheel() + getSpellcheck() + getSrc() + getStyle() + getTabindex() + getTitle() + getTranslate() + getType() + getOpene()
