...
void div::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class div

// Not supported in HTML5. Specifies the alignment of the content inside a <div> element 
void div::set(| string scalar left, string scalar right, string scalar center, string scalar justify) { 

    // Declare member variables based on arguments 
    string scalar locleft, "locright", "loccenter", "locjustify" 
    ...
    // Set the attribute  for this class 
    this. = locleft + "locright" + "loccenter" + "locjustify"
...
void div::set(| string scalar script) { 
...
string scalar div::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class div
