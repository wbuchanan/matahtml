...
void strong::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class strong
...
void strong::set(| string scalar script) { 
...
string scalar strong::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class strong
