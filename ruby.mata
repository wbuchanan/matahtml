...
void ruby::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class ruby
...
void ruby::set(| string scalar script) { 
...
string scalar ruby::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class ruby
