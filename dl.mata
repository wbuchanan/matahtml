...
void dl::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class dl
...
void dl::set(| string scalar script) { 
...
string scalar dl::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class dl
