...
void details::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class details
...
void details::set(| string scalar script) { 
...
void details::set(| string scalar open) { 
...
string scalar details::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class details
