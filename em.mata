...
void em::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class em
...
void em::set(| string scalar script) { 
...
string scalar em::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class em
