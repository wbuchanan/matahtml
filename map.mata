...
void map::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class map
...
void map::set(| string scalar mapname) { 

    // Declare member variables based on arguments 
    string scalar locmapname 
...
void map::set(| string scalar script) { 
...
string scalar map::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class map
