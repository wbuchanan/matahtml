...
void header::set(| string scalar methodarg) { 
...
} // End of Method  declaration for class header
...
void header::set(| string scalar script) { 
...
string scalar header::get() { 

    // Returns the  variable 
    return(this. + " ") 

} // End of getter method for  member of class header
